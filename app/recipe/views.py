...
class BaseRecipeAttrViewSet(mixins.DestroyModelMixin,
    ...
    """Base class viewset for the recipe attributes."""
    authentication_classes = [TokenAuthentication]
    permission_classes = [IsAuthenticated]
...
class TagViewSet(BaseRecipeAttrViewSet): # mixins defined first before viewsets, since it can override some behavior
